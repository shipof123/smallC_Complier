...
enum Dec_t{	   Dec_global_var_array,
		   Dec_global_struct,
		   Dec_local_var_array,
		   Dec_local_struct};
...
struct DecNode
{
	...
	void init_dec_local_var_array(vector<var_array* > var_array_vector) {
		dec_type = Dec_local_var_array;
		dec_var_array_vector = var_array_vector;
	}
	void init_dec_global_var_array(vector<var_array* > var_array_vector) {
		dec_type = Dec_global_var_array;
		dec_var_array_vector = var_array_vector;
	}
	void init_dec_local_struct() {
		dec_type = Dec_local_struct;
	}
	void init_dec_global_struct() {
		dec_type = Dec_global_struct;
	} 
};
struct StmtNode
{
