...
{
entry:
  %call1 = call i32 (i8*, ...)* @__isoc99_scanf(i8* getelementptr inbounds ([3 x i8]* @.str, i32 0, i32 0), i32* @n)
  %r58 = load i32* @n, align 4
  %r59 = icmp sgt i32 %r58, 16
  br i1 %r59, label %if2.then, label %if2.else

if2.then:
  %call2 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([3 x i8]* @.str, i32 0, i32 0), i32 -1)
  %call3 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([2 x i8]* @.str1, i32 0, i32 0))
  br label %if2.end

if2.else:
  %call4 = call i32 @dfs(i32 0)
  %r60 = load i32* @ans, align 4
  %call5 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([3 x i8]* @.str, i32 0, i32 0), i32 %r60)
