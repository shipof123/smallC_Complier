...
void semantics_check_exp(Node *p, char *s);
...
void semantics_check_exps(Node *p);
...
void semantics_check(Node* p) {
	switch (p->type) {
		...
		//case Extvars: semantics_check_sextvars(p); break;
		case Extvars: semantics_check_extvars(p); break;
		...
		case Exp: semantics_check_exp(p,NULL); break;
		case Exps: semantics_check_exps(p); break;
